function [] = train_GenderComposite_res50()
...
% give image folders
imds = imageDatastore({'./img/GenderComposite/female/correct',...
                       './img/GenderComposite/male/correct'}); 
Labels = cell(numel(imds.Files), 1);
Labels(contains(imds.Files, '/male'))   = {'male'};
Labels(contains(imds.Files, '/female')) = {'female'};
...
DNN.net      = net;
save('./data/trained_GenderComposite_res50.mat', 'DNN', '-v7.3');
