function [] = train_EmotionComposite_indiv_res50()
% Bubbles Deep Neural Network Test
% https://de.mathworks.com/help/deeplearning/getting-started-with-deep-learning-toolbox.html
addpath('./func');

% all images
folder1 = dir('./img/EmotionComposite/happyCorrect/*.png');
folder2 = dir('./img/EmotionComposite/happyNeutralCorrect/*.png');
...
Labels(contains(imageSubSet, '/happyCorrect'))   = {'happy'};
Labels(contains(imageSubSet, '/happyNeutralCorrect')) = {'happyNeutral'};
...
save(['./data/trained_EmotionComposite_', vpNames{vp}, '-', group, '_res50.mat'], 'DNN', '-v7.3');
